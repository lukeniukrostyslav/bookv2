...
Purpose: prevent contradictions while the novel evolves.

| ID | Element | Established fact | Source/checkpoint | Status |
|---|---|---|---|---|
| C-000 | Project | Book V2 is a new novel | Initialization | VERIFIED |
...
| C-001 | Setting | Porto Nero is a fictional Ligurian coastal town; approx. 18,000 permanent residents | WORLD_ATMOSPHERE_B4 | VERIFIED |
